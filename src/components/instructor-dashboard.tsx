...
import { InstructorAnalytics } from "./dashboard/InstructorAnalytics";
...
export function InstructorDashboard() {
  ...
  const { data: coursesData } = useGetInstructorCoursesQuery({ limit: 1000 });
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-16 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      {/* ================= ADVANCED ANALYTICS ================= */}
      <InstructorAnalytics courses={courses} statistics={statistics} />
