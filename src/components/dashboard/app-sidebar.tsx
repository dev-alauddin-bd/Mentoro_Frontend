...
export function AppSidebar() {
  ...
  const instructorItems = [
    ...
    { title: t("nav.curriculum"), url: "/dashboard/instructor/manage-modules", icon: Files },
    { title: t("nav.lessons"), url: "/dashboard/instructor/manage-lessons", icon: PlayCircle },
    { title: t("nav.revenue"), url: "/dashboard/instructor/manage-revenue", icon: Zap },
    { title: t("nav.live_workshops"), url: "/dashboard/instructor/manage-live-sessions", icon: Video },
    { title: t("nav.assignments"), url: "/dashboard/instructor/manage-assignments", icon: ClipboardList },
